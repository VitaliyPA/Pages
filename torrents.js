          ...
          if (e.type == 'complite') {
            ...
            btn.on('hover:enter', function () {
              ...
              var jackett = { 
                ...
                jackett_url_pva: Lampa.Storage.get('jackett_url_pva', ['jacred.xyz', 'jacred.ru', 'jacred.freebie.tom.ru', 'jacred.my.to', 'api.prisma.ws', 'https://lampa.app', 'jr.maxvol.pro', 'https://jacred.viewbox.dev', '#freebie.tom.ru:9117'].join(';')),
